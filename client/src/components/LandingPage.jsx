...
const LandingPage = () => {
  ...
  const portfolioItems = [
    { id: 1, brand: "Cafe Pyala", type: "Restaurant", img: "/src/assets/gallery1.png" },
    { id: 2, brand: "Ahmed's Walima", type: "Wedding Event", img: "/src/assets/gallery1.png" },
    { id: 3, brand: "TechZone PK", type: "Corporate", img: "/src/assets/gallery1.png" },
    { id: 4, brand: "Gym Fit", type: "Fitness", img: "/src/assets/gallery1.png" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {portfolioItems.map((item) => (
              <div key={item.id} className="group relative rounded-2xl overflow-hidden shadow-lg cursor-pointer">
