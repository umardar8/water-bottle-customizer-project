          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-48 h-48 bg-gray-200 rounded-full overflow-hidden mb-6 shadow-lg border-4 border-white">
                 <img src='/src/images/founders/founder1.png' alt="Umar Farooq Dar" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-48 h-48 bg-gray-200 rounded-full overflow-hidden mb-6 shadow-lg border-4 border-white">
                 <img src="/src/images/founders/founder1.png" alt="Aqib Ali Gaho" className="w-full h-full object-cover" />
              </div>
