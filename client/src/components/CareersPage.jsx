  ...
  const jobs = [
    {
      ...
      type: "Full-time",
      description: "We are looking for someone who loves Nastaliq typography and packaging design to lead our template library."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      location: "Remote",
      type: "Contract",
      description: "Help us optimize our 3D Three.js engine and build new features for the design tool."
    }
  ];
  ...
  return (
    <div className="font-sans text-gray-800 bg-white min-h-screen">
      ...
      <div className="bg-gray-900 text-white py-24 px-6 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">Build the Future of Packaging</h1>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="p-6 bg-purple-50 rounded-2xl">
            ...
            <p className="text-gray-600">From Hyderabad to Peshawar, we empower local businesses to look world-class.</p>
          </div>
        </div>
      </div>
